...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18712})) then -- Item: Note with Fist Insignia
		...
		e.other:SummonItem(13507); -- Item: Torn Cloth Tunic*
		e.other:Ding();
		e.other:Faction(309,100,0); -- Faction: Silent Fist Clan
		e.other:Faction(262,15,0); -- Faction: Guards of Qeynos
		e.other:Faction(361,15,0); -- Faction: Ashen Order
		e.other:AddEXP(100);
	end
