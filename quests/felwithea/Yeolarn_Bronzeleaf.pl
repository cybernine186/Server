...
sub EVENT_ITEM {
	...
	if (plugin::plugin::check_handin(\%itemcount, 18780 => 1)) {
	...
	if (plugin::plugin::check_handin(\%itemcount, 13073 => 4)) {
	...
	if (plugin::plugin::check_handin(\%itemcount, 10199 => 4)) {
	...
	if (plugin::plugin::check_handin(\%itemcount, 1570 => 1, 12514 => 1, 19065 => 1, 12513 => 1)) {
	...
	if (plugin::plugin::check_handin(\%itemcount, 1571 => 1, 1599 => 1)) {
