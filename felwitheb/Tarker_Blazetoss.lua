...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 13758})) then
		...
		e.other:SummonItem(eq.ChooseRandom(7007,13009,10004,59964,6012)); -- Item(s): Rusty Dagger (7007), Bandages (13009), Copper Band (10004), Spell: Numbing Cold (59964), Worn Great Staff (6012)
		e.other:Ding();
