...
if(quest::is_the_ruins_of_kunark_enabled()){
	sub EVENT_ITEM {
		#Tainted Darksteel Breastplate, Pure Crystal
		if ($itemcount{29001} == 1 && $itemcount{29006} == 1) {
			...
			quest::summonitem(29004); #Gleaming Crested Breastplate
		}   
		#Tainted Darksteel Sword, Bucket of Pure Water
		elsif ($itemcount{29000} && $itemcount{29009} == 1) {
			...
			quest::summonitem(29003); #Gleaming Crested Sword
		} 
		#Gleaming Crested Breastplate, Gleaming Crested Sword, Gleaming Crested Shield
		elsif ($itemcount{29003} && $itemcount{29004} && $itemcount{29005} == 1) {
			...
			quest::summonitem(29010); #Mark of Atonement
		} else {
			plugin::traindiscs();
