--Vegalys Keldrane: Qeynos Badge of Honor Quests
function event_say(e)
    ...
    -- (18289) Item: Investigator's Briefing
    ...
    -- (2386) Item: Investigator's Badge
...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 2386})) then -- Item: Investigator's Badge
		...
		e.other:Ding();
		e.other:AddEXP(2000);
	elseif(item_lib.check_turn_in(e.trade, {item1 = 2583},0)) then -- Item: Researcher's Badge
		...
		e.other:QuestReward(e.self,0,0,0,0,2694,2000); -- Item: Seal of Vegalys
	elseif(item_lib.check_turn_in(e.trade, {item1 = 2694,item2 = 2392})) then -- Item: Seal of Vegalys && Item: Head of Azibelle Spavin
		...
		e.other:Faction(219,5); -- Faction: Antonius Bayle
		e.other:Faction(262,5); -- Faction: Guards of Qeynos
		e.other:Faction(304,-5); -- Faction: Ring of Scale
		e.other:Faction(273,-5); -- Faction: Kane Bayle
		e.other:Faction(291,5); -- Faction: Merchants of Qeynos
		e.other:QuestReward(e.self,0,0,0,0,2388,2000); -- Item: Qeynos Badge of Honor
	end
